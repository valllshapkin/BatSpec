...
from BatSpec.QtUp import Locales

from pathlib import Path
ScriptDir = Path(__file__).parent

class Settings(Locales.Settings):
    SETTING_PATH = str(ScriptDir / "__assets__" / "LocalesSettings.ini")

Locales.DEBUG = False
Locales.JIT_TRANSLATE_COMPILATION = False
Locales.SETTINGS = Settings()
Locales.SUPPORTED_LANGUAGES.extend([
