...
from BatSpec.Logic.SpecWorker.GRAPH import (
    ...
    filterLabelsCurves, makeLabels, filterLabelsHDBSCAN
)
...
CURVES = filterLabelsCurves(BINARY, BINARY, threshold=66)
updateVisLayer("CURVES", CURVES)

#from BatSpec.Logic.SpecWorker.Morphology.GRAPH import morphClose
#SKELETONS = morphClose(CURVES, radius=2)
